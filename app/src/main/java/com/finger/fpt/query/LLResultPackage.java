...
public class LLResultPackage {
    ...
    private List<LLResultMsgSet> llResultMsgSets;
    ...
    public List<LLResultMsgSet> getLlResultMsgSets() {
        return llResultMsgSets;
    }

    public void setLlResultMsgSets(List<LLResultMsgSet> llResultMsgSets) {
        this.llResultMsgSets = llResultMsgSets;
    }
}
