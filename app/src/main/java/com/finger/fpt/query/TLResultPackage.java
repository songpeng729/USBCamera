...
public class TLResultPackage {
    ...
    private List<TLResultMsgSet> tlResultMsgSets;
    ...
    public List<TLResultMsgSet> getTlResultMsgSets() {
        return tlResultMsgSets;
    }

    public void setTlResultMsgSets(List<TLResultMsgSet> tlResultMsgSets) {
        this.tlResultMsgSets = tlResultMsgSets;
    }
}
