...
public class PermissionsUtils {
    ...
    private static com.finger.usbcamera.util.PermissionsUtils permissionsUtils;
    private IPermissionsResult mPermissionsResult;

    public static com.finger.usbcamera.util.PermissionsUtils getInstance() {
        if (permissionsUtils == null) {
            permissionsUtils = new com.finger.usbcamera.util.PermissionsUtils();
        }
